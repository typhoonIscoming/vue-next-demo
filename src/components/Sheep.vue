<template>
    ...
    <div v-else class="box">
        ...
        <div class="tools">
            道具：
            <button :disabled="!tools.save" @click="saveCard">
                取出3个卡片
            </button>
        ...
        saveCard() {
            ...
            setTimeout(() => {
                this.saveList.forEach((item, index) => {
                    item.style.top = "110%";
                    item.style.left =
                        this.leftOffset + index * CardItem.x * 2 + "px";
...
.card-item {
    ...
    cursor: pointer;
    transition: all 0.3s;
    box-shadow: 0px 3px 0 0 #fff, 0 8px 0 0 #ddd, 0 8px 0 2px #333,
        0 0 0 2px #333;
}
...
.item-cover {
    pointer-events: none;
    box-shadow: 0px 3px 0 0 #999, 0 8px 0 0 #666, 0 8px 0 2px #000,
        0 0 0 2px #000;
}
